/*
 ...
 //toggle kraych mhnje ON asel tr OFF .....OFF asel tr ON
...
int ToggleBit(int iNo, int iPos)
{
    ...
    if((iPos < 1) || (iPos > 32)) //check range of position given by user is valid or not
    {
        return 0;
    }
...
iMask                      0000   0000    0000    0000    0000    0000    0000    1000   ^
 ...
 iResult                   0000   0000      0000    0000    0000  0000    0011   0000  =48
